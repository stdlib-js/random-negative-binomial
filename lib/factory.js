...
var base = require( '@stdlib/random-base-negative-binomial' );
...
/**
* Returns a function for generating pseudorandom numbers drawn from a negative binomial distribution.
*
* @name factory
* @type {Function}
