...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a negative binomial distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, r: number | T, p: number | U, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from a negative binomial distribution.
	*
	* @param r - number of successes until experiment is stopped
	* @param p - success probability
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( r: number | T, p: number | U, out: V ): V;
}
...
interface Random extends PRNG {
	...
	*
	* @example
	* var out = negativeBinomial( [ 3, 3 ], 17, 0.5 );
	* // returns <ndarray>
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, r: number | T, p: number | U, options?: Options ): RandomArray;
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a negative binomial distribution.
	*
	* @param options - function options
